...
SNR = 0:5:30; %10:5:35;
Rows = [1500 1509; 4000 4004]; %[550 568; 3540 3595; 5150 5160];
for snr = SNR
    for r = 1:size(Rows, 1)
        ...
        if dataset_params.staticChan == 1
            ...
            save_folder = ['DeepMIMO_Data/Static_BS16/freq_symb_',num2str(bs_ant),'ant_',num2str(subs),'sub_ver5'];
            save_file = [save_folder, '/Gan_',num2str(snr),'_dB',filename];
            if ~exist(save_folder, 'dir')
                mkdir(save_folder);
            end
            save(save_file,'H_data', 'H_linear_data', 'H_equalized_data', 'Y_data', 'H_practical_data',"dataset_params",'-v7.3');
        end
    end
end
...
fileID = fopen('DeepMIMO_Data/Static_BS16/freq_symb_1ant_612sub_ver5/readme.txt', 'w');  
...
content = ['This file is generated by LoopSNR_v5_Rows1500_1509_4000_4004 with:', newline, ...
           '1. BS 16', newline, ...
           '2. fc 3.4 GHz', newline, ...
           '3. Rows 1500_1509, 4000_4004', newline];
