...
SNR = 0:5:30; %10:5:35;
Rows = [1600 1609; 3853 3857]; %[550 568; 3540 3595; 5150 5160];
for snr = SNR
    for r = 1:size(Rows, 1)
        ...
        if dataset_params.staticChan == 1
            ...
            save(['DeepMIMO_Data/Static_BS16/freq_symb_',num2str(bs_ant),'ant_',num2str(subs),'sub_ver2/Gan_',num2str(snr),'_dB',filename],'H_data', 'H_linear_data', 'H_equalized_data', 'Y_data', 'H_practical_data',"dataset_params",'-v7.3');
        end
    end
end
