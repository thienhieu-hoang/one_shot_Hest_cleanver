...
class FineTuneModel2(nn.Module): # avoiding padding at last layers
    def __init__(self, source_model):
        super(FineTuneModel2, self).__init__()
        ...
        # Replace conv5
        self.conv5 = nn.Conv2d(32, 16, kernel_size=(5, 5), stride=(1, 1), padding=(4, 4))
        
        # Add layers
        self.conv6 = nn.Conv2d(16, 8, kernel_size=(3, 3), stride=(1, 1), padding=(0, 0))
        self.conv7 = nn.Conv2d( 8, 1, kernel_size=(3, 3), stride=(1, 1), padding=(0, 0))
